...
if __name__ == "__main__":
    file_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'raw', 'price_prediction_dataset.csv')
    save_file_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'processed', 'clean_price_prediction.csv')
